...
enum reionization_parametrization {
  ...
  reio_inter_DH,       /**< llh linear interpolation between specified points */
};
...
struct thermodynamics
{
  ...
  //llh
  double mDMdec; /**< parameter describing the mass of decaying DM decay*/
  double gDMdec; /**< parameter describing the coupling of decaying DM decay*/
