...
/**
llh : reionization parameters with Einj from axions
 **/
class_string_parameter(xeaxion_file,"/external/heating/xe_fromDH_reggrid.dat","xeaxion file")
/*
...
/*llh*/
class_string_parameter(chi_z300_axion,"/external/heating/axion_f300_gridforCLASS.dat","Axion_f300_file") /**file containing a list of ma ga and f_h,f_ly,fi computed at z=300 to be interpolated */
class_string_parameter(chi_x_filellh,"/external/heating/example_chix_file.dat","Example_filex") /**< File containing the chi approximation according to Galli et al 2013 */
