...
/*llh added chi_RI*/
//enum chi_approx {chi_CK, chi_PF,chi_RI, chi_Galli_file, chi_Galli_analytic, chi_full_heating, chi_from_x_file, chi_from_z_file};
/*llh added chi_from_axion_file*/
enum chi_approx {chi_CK, chi_PF, chi_Galli_file, chi_Galli_analytic, chi_full_heating, chi_from_x_file, chi_from_z_file,chi_from_axion_file};
...
struct injection{
  ...
  //llh efficiencies of energy deposition a z=300 first computed in injection_init through injection_read_f300_from_axionfile and then feeded in chi's in injection_deposition_function_at_z
  double fheat300;
  double fHion300;
  double fHeion300;
  double flya300;
...
extern "C" {
  ...
  int injection_read_chi_x_from_file(struct precision* ppr,
                                     struct injection* phe,
                                     char* chi_x_file);
  /*llh: Deposition fn for axion decays at z=300*/
